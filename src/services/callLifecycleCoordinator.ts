...
// Duration ceilings live in callDurationPolicy — a pure module, so scripts and
// tests can read them without constructing this file's singleton (which starts
// a DB reconciler on import). Re-exported so existing importers are unaffected.
import {
...
export { getMaxDurationMs, ABSOLUTE_MAX_CALL_DURATION_MS };
