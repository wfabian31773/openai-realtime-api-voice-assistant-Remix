...
**AND THE SEQUENCE HAS TWO HOLES IN IT ON PURPOSE: v13 AND v57. v72 IS THE
NEWEST AND SITS ON THIS BRANCH; v70 IS WHAT `main` CARRIES, SINCE #293 MERGED
2026-09-24 (`c247479`), AND v57, v59, v60, v63, v65 AND v66 ARE ALL RETIRED
RATHER THAN REUSED — see THE SURGEON CLAIM below the table for v57.** **THIS LINE GOES
...
**THEY WERE ONE NUMBER FOR EXACTLY ONE DAY, AND v71 SPLIT THEM AGAIN** — which
the paragraph that stood here predicted in as many words ("the next branch to
take v71 splits them again, and this paragraph goes stale the moment it does").
It is the ordinary state, not a problem: a branch that ships sits ABOVE `main`
until it merges, and only a marker BELOW `main` reads as a failed pull.
...
takes **v73**. v19-v24 were siblings off v18 on 2026-09-15 — v19 the PCP lost-requestfloor (#300), v20 the blind transfer telemetry (#302), v21 the ask detection
