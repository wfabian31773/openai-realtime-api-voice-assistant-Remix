...
**AND THE SEQUENCE HAS TWO HOLES IN IT ON PURPOSE: v13 AND v57. v59 IS THE
NEWEST, AND v57 WAS WITHDRAWN — see THE SURGEON CLAIM below the table.** v58 is
claimed by an OPEN branch (the identity probe) and v59 by another (#293, RULE
ZERO 2a's gate), so **they are SIBLINGS and neither contains the other** —
v59 > v58 numerically and says nothing about containment. Whichever lands
second must merge `main` and re-bump above whatever it then carries. v13 was
#293's original number and it yielded: that branch merged `main` at v56 and
re-bumped to v59, which is the rule working rather than a renumbering. v19-v24 were siblings off v18 on 2026-09-15 — v19 the PCP lost-request
...
never read v57; the next ship takes v58. **Two fixes that rode in with it STAY
