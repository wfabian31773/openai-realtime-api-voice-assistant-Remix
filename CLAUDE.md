...
**AND THE SEQUENCE HAS A HOLE IN IT ON PURPOSE: v13 IS SKIPPED. v17 IS THE
NEWEST** — v14 (the PCP queue choice), v15 (PCP records), v16 (professional
records), then v17 (PCP scheduling to the Hub), each stacked on the one
before, so v17 contains all four. #293 has held
...
carries** — it branched off v10 and contains neither v11, v12, v14, v16 nor
v17, so landing it at v13 would send `/voice/health` BACKWARDS past five live
markers and read as a failed pull.
