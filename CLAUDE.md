...
**v58 AND v59 ARE CLAIMED BY OPEN BRANCHES** — v58 by #322 (the identity probe)
and v59 by #293 (RULE ZERO 2a's gate) — so v60 is a SIBLING of both and
contains NEITHER. v60 > v59 numerically and says nothing whatever about
containment, which is the exact hazard this table documents for v19-v24.
Whichever of the three lands last must merge `main` and re-bump above whatever
it then carries. v19-v24 were siblings off v18 on 2026-09-15 — v19 the PCP lost-request
